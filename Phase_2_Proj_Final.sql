...
COMMENT ON COLUMN Request.Operational_Manager_ID IS 'Foregn Key of the request table referencing Operational Manager table. ' 
;
...
COMMENT ON COLUMN Request_Tracker.Requestt_ID IS ' Foreign key of the request_tracker table referencing to the Request table.' 
;
...
ALTER TABLE Employee 
        ADD CONSTRAINT FK_Team_ID_CF FOREIGN KEY ( Team_ID ) REFERENCES Campaign_Team ( OTeam_ID ) NOT DEFERRABLE;     
    


-- 6. Creation /DDL for Table Champign_Team
...
COMMENT ON COLUMN Campaign_Team.Camapign_Team_Size IS 'Column tells about the number of employees or team members in the particular team ' 
;
...
;    
    ...
    ALTER TABLE Campaign_Team 
        ADD CONSTRAINT FK_Employee_ID FOREIGN KEY ( Employee_ID ) REFERENCES Employee ( Employee_ID ) NOT DEFERRABLE;
...
COMMENT ON COLUMN Social_Media_Handler.Employee IS 'The foreign key of the Social Media Handler table which refers to the Employee table. It along with Employee Code acts as the Primary Key of this table' 
;
...
COMMENT ON COLUMN Web_Developer.Employee IS 'The foreign key of the Web Developer table which refers to the Employee table. It along with Employee Code acts as the Primary Key of this table' 
;
...
COMMENT ON COLUMN Content_Writer.Employee IS 'The foreign key of the Content Writer table which refers to the Employee table. It along with Employee Code acts as the Primary Key of this table' 
;
...
COMMENT ON COLUMN Graphic_Designer.Employee IS 'The foreign key of the Graphic Designer table which refers to the Employee table. It along with Employee Code acts as the Primary Key of this table' 
;
...
INSERT INTO Request ( Client_Request_ID, Client_ID, Operational_Manager_ID, Is_Approved )
                   VALUES ( 101, 000001, 500, 'Y');
INSERT INTO Request ( Client_Request_ID, Client_ID, Operational_Manager_ID, Is_Approved )
                   VALUES ( 102, 000002, 501, 'N');
INSERT INTO Request ( Client_Request_ID, Client_ID, Operational_Manager_ID, Is_Approved )
                   VALUES ( 103, 000003, 502, 'Y');
INSERT INTO Request ( Client_Request_ID, Client_ID, Operational_Manager_ID, Is_Approved )
                   VALUES ( 104, 000004, 503, 'Y');
INSERT INTO Request ( Client_Request_ID, Client_ID, Operational_Manager_ID, Is_Approved )
                   VALUES ( 105, 000005, 504, 'Y');
INSERT INTO Request ( Client_Request_ID, Client_ID, Operational_Manager_ID, Is_Approved )
                   VALUES ( 106, 000006, 505, 'Y');
INSERT INTO Request ( Client_Request_ID, Client_ID, Operational_Manager_ID, Is_Approved )
                   VALUES ( 107, 000007, 506, 'Y');
INSERT INTO Request ( Client_Request_ID, Client_ID, Operational_Manager_ID, Is_Approved )
                   VALUES ( 108, 000008, 507, 'Y');
INSERT INTO Request ( Client_Request_ID, Client_ID, Operational_Manager_ID, Is_Approved )
                   VALUES ( 109, 000009, 508, 'Y');
INSERT INTO Request ( Client_Request_ID, Client_ID, Operational_Manager_ID, Is_Approved )
                   VALUES ( 110, 000010, 509, 'Y');                   
...
INSERT INTO Employee (Employee_ID, Employee_Name, Team_ID,Operational_Manager_ID, Shift_Type)
                   VALUES ( 10000005,'Ragghav_Aggarwal', '#122',0110299, 'N');
INSERT INTO Employee (Employee_ID, Employee_Name, Team_ID,Operational_Manager_ID, Shift_Type)
                   VALUES ( 10000004,'Amit_Madaan', '#122',0110299, 'N');
INSERT INTO Employee (Employee_ID, Employee_Name, Team_ID,Operational_Manager_ID, Shift_Type)
                   VALUES ( 10000003,'Mandeep_Kaur_Sidhu', '#122',0110999, 'N');
INSERT INTO Employee (Employee_ID, Employee_Name, Team_ID,Operational_Manager_ID, Shift_Type)
...
INSERT INTO Campaign_Team (Team_ID, Campaign_Team_Size, Project_Name)
                   VALUES ( '#147',6, 'Singing_with_the_Stars');  
INSERT INTO Campaign_Team (Team_ID, Campaign_Team_Size, Project_Name)
